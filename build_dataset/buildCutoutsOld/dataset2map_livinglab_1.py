...
if __name__ == '__main__':
    spaceName = 'livinglab_1'
    cutoutName = 'cutouts_36'
    datasetDir ='/local/localization_service/Maps/SPRING'
    sourceDataDir = '/local/localization_service/Data/spring/broca/livinglab_1'
    ...
    pano_prefix = 'Broca-Living-Lab-with-Curtains-scan'
    
    spaceDir = os.path.join(datasetDir, spaceName)
    if not os.path.isdir(spaceDir):
        os.mkdir(spaceDir)
